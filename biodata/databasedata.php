...
class Biodata extends Database {
    ...
    // Menambah Data
    public function create( $nama, $almt,$tgl,$jk,$agm,$umur)
    {
        
        mysqli_query($this->koneksi,"insert into biodata values('','$nama', '$almt','$tgl','$jk','$agm','$umur')");
    }
    ...
    public function update($id, $nama, $almt,$tgl,$jk,$agm,$umur)
    {
         mysqli_query($this->koneksi,"update biodata set nama='$nama', alamat='$almt' ,tgl_lahir='$tgl',jenis_kel='$jk',agama='$agm',umur='$umur' where id='$id'");
    }
